...
import { TeacherScheduleCell } from './TeacherScheduleCell';
import { ChevronLeft, ChevronRight } from "lucide-react";

export const TeacherCalendar = ({ sessionData, teacherId }) => {
  const [currentPage, setCurrentPage] = useState(0);
  const daysPerPage = 5;

  // Time slots from session data
  const TIME_SLOTS = [
    `${sessionData.timeSlots.slot1.start}-${sessionData.timeSlots.slot2.end}`,
    `${sessionData.timeSlots.slot3.start}-${sessionData.timeSlots.slot4.end}`
  ];
